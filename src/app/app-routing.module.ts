...
import { NouvelVentComponent } from './pages/ventes/nouvel-vent/nouvel-vent.component';
import { PageVentesComponentComponent } from './pages/ventes/page-ventes-component/page-ventes-component.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'nouvel-vente',
        component: NouvelVentComponent,
        canActivate: [ApplicationGuardService]
      },
      {
        path: 'ventes',
        component: PageVentesComponentComponent,
        canActivate: [ApplicationGuardService]
      },
      {
        path: 'utilisateurs',
